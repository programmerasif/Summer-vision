                    ...
                    <SwiperSlide>
                        <div className="custom-container mt-20">
                            <div className="grid sm:grid-cols-1 md:grid-cols-2 justify-center items-center md:gap-24 sm:gap-12">
                                ...
                                <Fade>    <h5 className="md:text-3xl sm:text-xl font-semibold text-[#000000] md:leading-[3rem] sm:leading-[1rem]">Make your summer day joyful<br />  and full of happiness with our trainer</h5> </Fade>
                                <Fade> <p>In the warmth of the summer sun, join our exceptional trainer who will inspire and guide you on a transformative journey.our trainer will empower you to unlock a summer filled with happiness, paving the way for radiant memories that will last a lifetime.</p> </Fade>
